...
abstract class _CurrentUser implements CurrentUser {
  const factory _CurrentUser(
      ...
      required final bool blacklistAvatars,
      required final bool blacklistUsers,
      required final bool descriptionCollapsedInitially,
      required final bool hideComments,
      required final bool showHiddenComments,
      required final bool showPostStatistics,
      required final bool hasMail,
      required final bool receiveEmailNotifications,
      required final bool enableKeyboardNavigation,
      required final bool enablePrivacyMode,
      required final bool styleUsernames,
      required final bool enableAutoComplete,
      required final bool hasSavedSearches,
      required final bool disableCroppedThumbnails,
      required final bool disableMobileGestures,
      required final bool enableSafeMode,
      required final bool disableResponsiveMode,
      required final bool disablePostTooltips,
      required final bool noFlagging,
      required final bool noFeedback,
      required final bool disableUserDmails,
      required final bool enableCompactUploader,
      required final DateTime updatedAt,
      required final String email,
      required final DateTime lastLoggedInAt,
      required final DateTime? lastForumReadAt,
      required final String? recentTags,
      ...
      required final int apiRegenMultiplier,
      required final int apiBurstLimit,
