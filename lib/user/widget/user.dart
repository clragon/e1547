  ...
  Widget build(BuildContext context) {
    return _UserPageProvider(
      ...
      child: Consumer<_UserPageControllers>(
        builder:
            (context, controllers, child) => LayoutBuilder(
              builder: (context, constraints) {
                Widget body;
                PreferredSizeWidget? appbar;
                Map<Widget, WidgetBuilder> tabs = {
                  const Tab(text: 'Favorites'):
                      (context) => ChangeNotifierProvider<PostController>.value(
                        value: controllers.favoritePosts,
                        builder:
                            (context, child) => PostSliverDisplay(
                              controller: controllers.favoritePosts,
                            ),
                      ),
                  const Tab(text: 'Uploads'):
                      (context) => ChangeNotifierProvider<PostController>.value(
                ...
                return ControllerHistoryConnector<PostController?>(
                  controller: controllers.profilePost,
                  addToHistory:
                      (context, client, controller) => client.histories.addUser(
                        user: user,
      ...
      itemBuilder:
          (context) => [
            PopupMenuTile(
              ...
              value:
                  () async =>
                      launch(context.read<Client>().withHost(user.link)),
            ),
            PopupMenuTile(
              title: 'Report',
              icon: Icons.report,
...
class _UserPageProvider extends SubProvider<Client, _UserPageControllers> {
  ...
  _UserPageProvider({required User user, super.child, super.builder})
    : super(
        create:
            (context, client) => _UserPageControllers(
