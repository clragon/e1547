  ...
  Widget build(BuildContext context) {
    Widget buildEditTextField(
      ...
      child: ControlledTextWrapper(
        ...
        submit: submit,
        builder:
            (context, controller, submit) => TagInput(
              controller: controller,
              decoration: const InputDecoration(
                suffix: PromptTextFieldSuffix(),
              ),
                              ...
                              (context, index) => DenylistTile(
                                ...
                                onDelete:
                                    () => client.accounts.push(
                                      traits: traits.copyWith(
                                        denylist:
                                            denylist..remove(denylist[index]),
                                      ),
                                    ),
                              ),
                        ),
