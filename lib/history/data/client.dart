...
import 'package:e1547/history/data/client.drift.dart';
...
class HistoryClient extends DatabaseAccessor<GeneratedDatabase>
    with $HistoryClientMixin {
  HistoryClient({required GeneratedDatabase database}) : super(database);
