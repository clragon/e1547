  ...
  Widget build(BuildContext context) {
    ...
    return SubChangeNotifierProvider<Client, HistoryController>(
      ...
      child: Consumer<HistoryController>(
        builder:
            (context, controller, child) => SelectionLayout<History>(
              ...
              child: RefreshableDataPage.builder(
                ...
                child:
                    (context) => PagedGroupedListView<int, History, DateTime>(
                      ...
                      groupHeaderBuilder:
                          (element) => ListTileHeader(
                            title: DateFormatting.named(element.visitedAt),
                          ),
                      itemComparator:
                          (a, b) => a.visitedAt.compareTo(b.visitedAt),
                      builderDelegate:
                          defaultPagedChildBuilderDelegate<History>(
                            pagingController: controller.paging,
