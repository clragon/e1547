...
class SettingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<Settings>(
      builder:
          (context, settings, child) => Scaffold(
                  ...
                  (context) => ListView(
                    ...
                    children: [
                      ...
                      Consumer<IdentityService>(
                        builder:
                            (context, service, child) => IdentityTile(
                      ...
                      Consumer<Client>(
                        builder:
                            (context, client, child) => ValueListenableBuilder(
                              valueListenable: client.traits,
                              builder:
                                  (context, traits, child) => ListTile(
                                    title: const Text('Blacklist'),
                                    leading: const Icon(Icons.block),
                                    subtitle:
                                        traits.denylist.isNotEmpty
                                            ? Text(
                      ...
                      Consumer<Client>(
                        builder:
                            (context, client, child) => SubStream<int>(
                                  ...
                                  (context, snapshot) => ListTile(
                                    ...
                                    subtitle:
                                        snapshot.data != null &&
                                                snapshot.data != 0
                                            ? Text(
                                              '${snapshot.data} searches followed',
                                            )
                                            : null,
                      ...
                      Column(
                        children: [
                          ...
                          ValueListenableBuilder<GridQuilt>(
                            ...
                            builder:
                                (context, value, child) => GridSettingsTile(
                                  state: value,
                                  onChange:
                                      (value) => settings.quilt.value = value,
                                ),
                          ),
                        ],
                      ),
                      ValueListenableBuilder<bool>(
                        ...
                        builder:
                            (context, value, child) => SwitchListTile(
                              ...
                              onChanged:
                                  (value) =>
                                      settings.showPostInfo.value = value,
                            ),
                      ),
                      const Divider(),
                      ...
                      ValueListenableBuilder<bool>(
                        ...
                        builder:
                            (context, value, child) => SwitchListTile(
                              ...
                              value: value,
                              onChanged:
                                  (value) => settings.upvoteFavs.value = value,
                            ),
                      ),
                      ValueListenableBuilder<bool>(
                        ...
                        builder:
                            (context, value, child) => SwitchListTile(
                              ...
                              value: value,
                              onChanged:
                                  (value) => settings.muteVideos.value = value,
                            ),
                      ),
                        ...
                        ValueListenableBuilder<bool>(
                          ...
                          builder:
                              (context, value, child) => SwitchListTile(
                                ...
                                onChanged:
                                    (value) =>
                                        settings.secureDisplay.value = value,
                              ),
                        ),
                        ...
                        ValueListenableBuilder<bool>(
                          ...
                          builder:
                              (context, value, child) => SwitchListTile(
                                ...
                                onChanged:
                                    (value) =>
                                        settings.incognitoKeyboard.value =
                                            value,
                              ),
                        ),
                      ValueListenableBuilder<String?>(
                      ...
                      SubFuture<bool>(
                        create:
                            () => LocalAuthentication()
                                ...
                                .then((e) => e.isNotEmpty),
                        builder:
                            (context, snapshot) => ValueListenableBuilder<bool>(
                      ...
                      ValueListenableBuilder<bool>(
                        ...
                        builder: (context, value, child) {
                          ...
                          return SwitchListTile(
                            ...
                            subtitle: Text(
                              value ? 'options shown' : 'options hidden',
                            ),
                            secondary: const Icon(Icons.bug_report),
                            value: value,
                            onChanged:
                                (value) => settings.showDev.value = value,
                          );
                        },
                      ),
                                    ...
                                    (context, snapshot) => ListTile(
                                      ...
                                      subtitle:
                                          (snapshot.data?.isNotEmpty ?? false)
                                              ? Text(
                                                '${snapshot.data!.length} errors logged',
                                              )
                                              : null,
                                      onTap:
